...
An automated Python pipeline that ingests, validates, transforms, and visualizes over **1,000,000 transaction records** from raw retail data into executive data marts. 
